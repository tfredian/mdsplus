...
static int Check(Widget w)
{
  ...
  if ( (xd = XmdsNidOptionMenuGetXd(XtNameToWidget(XtParent(w),"*mode"))) && 
       ...
       (mode == 1 || mode == 2) &&
       (xd = XmdsNidOptionMenuGetXd(XtNameToWidget(XtParent(w),"*freq1"))) && (TdiData(xd,&freq1_d MDS_END_ARG) & 1) &&
       (xd = XmdsNidOptionMenuGetXd(XtNameToWidget(XtParent(w),"*freq2"))) && (TdiData(xd,&freq2_d MDS_END_ARG) & 1) &&
       (xd = XmdsNidOptionMenuGetXd(XtNameToWidget(XtParent(w),"*freq3"))) && (TdiData(xd,&freq3_d MDS_END_ARG) & 1) &&
