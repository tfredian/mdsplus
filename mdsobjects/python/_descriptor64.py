...
class descriptor(_C.Structure):
    ...
    def _getValue(self):
        ...
        if self.dclass == CLASS_A:
            ...
            try:
                max_chunk=2<<28
                if descr.arsize/descr.length > max_chunk:
                    from _mdsshr import MdsBufferAddressPy
                    a=_N.ndarray(shape=shape,dtype=mdsdtypes(self.dtype).toCtype())
                    num=descr.arsize/descr.length
                    offset=0
                    while num > 0:
                        try:
                            ptr=MdsBufferAddressPy(descr.pointer,_C.c_uint64(offset))
                            num_this_time=max_chunk
                            if num_this_time > num:
                                num_this_time=num
                            dum=_N.ndarray(shape=[num_this_time,],
                                           dtype=mdsdtypes(self.dtype).toCtype(),
                                           buffer=buffer(_C.cast(ptr,
                                                                 _C.POINTER(mdsdtypes(self.dtype).toCtype() * num_this_time)).contents))
                            a.flat[offset:offset+num_this_time-1]=dum
                            offset=offset+num_this_time
                            num = num - num_this_time
                        except:
                            raise Exception,"Error with handling large array of shape: %s" % (str(shape),)
...
descriptor._fields_ = [("not_used",_C.c_ushort),
                       ("dtype",_C.c_ubyte),
                       ("dclass",_C.c_ubyte),
...
class descriptor_xd(_C.Structure):
    _fields_=descriptor._fields_+[("l_length",_C.c_uint64)]
...
class descriptor_r(_C.Structure):
    if os.name=='nt':
        _fields_=descriptor._fields_+[("ndesc",_C.c_uint),("dscptrs",_C.POINTER(descriptor)*256)]
    else:
        _fields_=descriptor._fields_+[("ndesc",_C.c_uint),("dscptrs",_C.POINTER(descriptor)*256)]
...
class descriptor_string(_C.Structure):
    _fields_=[("not_used",_C.c_ushort),("dtype",_C.c_ubyte),("dclass",_C.c_ubyte),("pointer",_C.c_char_p),("length",_C.c_uint)]
...
class descriptor_apd(_C.Structure):
    if os.name=='nt':
        _fields_=[("not_used",_C.c_ushort),("dtype",_C.c_ubyte),("dclass",_C.c_ubyte),("pointer",_C.POINTER(_C.POINTER(descriptor))),("length",_C.c_uint),("scale",_C.c_byte),("digits",_C.c_ubyte),
                  ("aflags",_C.c_ubyte),("dimct",_C.c_ubyte),("arsize",_C.c_uint64),("a0",_C.POINTER(_C.POINTER(descriptor))),("coeff_and_bounds",_C.c_int64 * 24)]
    else:
        _fields_=[("not_used",_C.c_ushort),("dtype",_C.c_ubyte),("dclass",_C.c_ubyte),("pointer",_C.POINTER(_C.POINTER(descriptor))),("length",_C.c_uint),("scale",_C.c_byte),("digits",_C.c_ubyte),
                  ("fill1",_C.c_ushort),
                  ("aflags",_C.c_ubyte),("fill2",_C.c_ubyte * 3),("dimct",_C.c_ubyte),("arsize",_C.c_uint64),("a0",_C.POINTER(_C.POINTER(descriptor))),("coeff_and_bounds",_C.c_int64 * 24)]
...
class descriptor_a(_C.Structure):
    if os.name=='nt':
        _fields_=[("not_used",_C.c_ushort),("dtype",_C.c_ubyte),("dclass",_C.c_ubyte),("pointer",_C.c_void_p),("length",_C.c_uint),
                  ("scale",_C.c_byte),("digits",_C.c_ubyte),
                  ("aflags",_C.c_ubyte),("dimct",_C.c_ubyte),("arsize",_C.c_uint64),("a0",_C.c_void_p),("coeff_and_bounds",_C.c_int64 * 24)]
    else:
        _fields_=[("not_used",_C.c_ushort),("dtype",_C.c_ubyte),("dclass",_C.c_ubyte),("pointer",_C.c_void_p),("length",_C.c_uint),
                  ("scale",_C.c_byte),("digits",_C.c_ubyte),("fill1",_C.c_ushort),
                  ("aflags",_C.c_ubyte),("fill2",_C.c_ubyte * 3),("dimct",_C.c_ubyte),("arsize",_C.c_uint64),("a0",_C.c_void_p),
                  ("coeff_and_bounds",_C.c_int64 * 24)]
