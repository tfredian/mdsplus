...
STATIC_CONSTANT struct descriptor minus_one = {DESCRIPTOR_HEAD_INI(sizeof(int), DTYPE_L, CLASS_S, (char *)&minus_one_value)};
...
struct TdiCatStruct		cats[4];
	...
	**************************/
	...
	struct descriptor begin = {DESCRIPTOR_HEAD_INI(0, 0, CLASS_S, 0)};
	struct descriptor delta = {DESCRIPTOR_HEAD_INI(0, 0, CLASS_S, 0)};
