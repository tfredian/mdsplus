...
STATIC_CONSTANT struct descriptor dmbig = DESCRIPTOR_INIT(sizeof(mbig),DTYPE_F,CLASS_S,(char *)&mbig);
STATIC_CONSTANT struct descriptor dbig = DESCRIPTOR_INIT(sizeof(big),DTYPE_F,CLASS_S,(char *)&big);
STATIC_CONSTANT struct descriptor dmhuge = DESCRIPTOR_INIT(sizeof(mhuge),DTYPE_L,CLASS_S,(char *)&mhuge);
STATIC_CONSTANT struct descriptor dhuge = DESCRIPTOR_INIT(sizeof(lhuge),DTYPE_L,CLASS_S,(char *)&lhuge);
STATIC_CONSTANT struct descriptor dmone = DESCRIPTOR_INIT(sizeof(mone),DTYPE_L,CLASS_S,(char *)&mone);
...
struct descriptor		dk0 = DESCRIPTOR_INIT(sizeof(int),DTYPE_L,CLASS_S,0);
struct descriptor		dk1 = DESCRIPTOR_INIT(sizeof(int),DTYPE_L,CLASS_S,0);
