...
static jobject DescripToObject(JNIEnv *env, struct descriptor *desc, 
						jobject helpObj, jobject unitsObj, jobject errorObj, jobject validationObj)
{
  jclass cls, data_cls;
  jmethodID constr;
...
//printf("CLASS_S\n");
      ...
      switch(desc->dtype) {
        case DTYPE_BU: 
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(BLMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
        ...
        case DTYPE_WU: 
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(SLMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
        ...
        case DTYPE_QU: 
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(JLMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
		...
		case DTYPE_FSC:
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(FLMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
		...
		case DTYPE_G :
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(DLMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
        ...
        case DTYPE_T :
		  ...
		  constr = (*env)->GetStaticMethodID(env, cls, "getData", "(Ljava/lang/String;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
...
//printf("CLASS_A\n");
		...
		switch(array_d->dtype) {
			...
			case DTYPE_WU: 
				...
				constr = (*env)->GetStaticMethodID(env, cls, "getData", "([S[ILMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
			...
			case DTYPE_QU: 
				...
				constr = (*env)->GetStaticMethodID(env, cls, "getData", "([J[ILMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
			...
			case DTYPE_FSC:
				...
				constr = (*env)->GetStaticMethodID(env, cls, "getData", "([F[ILMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
			...
			case DTYPE_G :
				...
				constr = (*env)->GetStaticMethodID(env, cls, "getData", "([D[ILMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
			...
			case DTYPE_T:
				...
				constr = (*env)->GetStaticMethodID(env, cls, "getData", "([Ljava/lang/String;[ILMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Data;");
...
//printf("CLASS_R %d\n", record_d->dtype);		  
		if(record_d->dtype != DTYPE_PARAM && record_d->dtype != DTYPE_WITH_UNITS && record_d->dtype != DTYPE_WITH_ERROR)
		{
			switch(record_d->dtype) {
				case DTYPE_SIGNAL: cls = (*env)->FindClass(env, "MDSplus/Signal");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Signal;");
					break; 
				case DTYPE_DIMENSION: cls = (*env)->FindClass(env, "MDSplus/Dimension"); 
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Dimension;");
					break;   
				case DTYPE_WINDOW: cls = (*env)->FindClass(env, "MDSplus/Window");
				...
				case DTYPE_CONGLOM: cls = (*env)->FindClass(env, "MDSplus/Conglom");
					...
					break;   
				case DTYPE_ACTION: cls = (*env)->FindClass(env, "MDSplus/Action"); 
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Action;");
					break;   
				case DTYPE_DISPATCH: cls = (*env)->FindClass(env, "MDSplus/Dispatch");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Dispatch;");
					break;   
				case DTYPE_PROGRAM: cls = (*env)->FindClass(env, "MDSplus/Program");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Program;");
					break;   
				case DTYPE_ROUTINE: cls = (*env)->FindClass(env, "MDSplus/Routine");  
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Routine;");
					break;   
				case DTYPE_PROCEDURE: cls = (*env)->FindClass(env, "MDSplus/Procedure");   
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Procedure;");
					break;   
				case DTYPE_METHOD: cls = (*env)->FindClass(env, "MDSplus/Method");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Method;");
					break;   
      			case DTYPE_DEPENDENCY: cls = (*env)->FindClass(env, "MDSplus/Dependency");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Dependency;");
					break;   
				case DTYPE_CONDITION: cls = (*env)->FindClass(env, "MDSplus/Condition"); 
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Condition;");
					break;   
				case DTYPE_CALL: cls = (*env)->FindClass(env, "MDSplus/Call");
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Call;");
					break;  
				case DTYPE_SLOPE:
 				case DTYPE_RANGE: cls = (*env)->FindClass(env, "MDSplus/Range"); 
	                constr = (*env)->GetStaticMethodID(env, cls, "getData", "(LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;LMDSplus/Data;)LMDSplus/Range;");
					break;   
			}
			...
			{
				(*env)->SetObjectArrayElement(env, jobjects, i, DescripToObject(env, record_d->dscptrs[i], 0,0,0,0));
			}
			...
			switch(record_d->dtype) {
				case DTYPE_PARAM: 
					return DescripToObject(env, record_d->dscptrs[0], 
						...
						unitsObj, errorObj, DescripToObject(env, record_d->dscptrs[2],0,0,0,0));
				case DTYPE_WITH_UNITS:
					return DescripToObject(env, record_d->dscptrs[0], helpObj,
						DescripToObject(env, record_d->dscptrs[1],0,0,0,0), errorObj, validationObj);
				case DTYPE_WITH_ERROR:
					return DescripToObject(env, record_d->dscptrs[0], 
						helpObj,unitsObj,DescripToObject(env, record_d->dscptrs[1],0,0,0,0), validationObj);
			}
		}
		return obj;
...
static struct descriptor *completeDescr(struct descriptor *dataDscPtr, struct descriptor *helpDscPtr, struct descriptor *unitsDscPtr, 
						  struct descriptor *errorDscPtr, struct descriptor *validationDscPtr)
{
	...
	if(errorDscPtr)
	{
		...
		currWithErrorDsc->data = completeDescr(dataDscPtr, helpDscPtr, unitsDscPtr, 0, validationDscPtr);
	...
	if(unitsDscPtr)
	{
		...
		currWithUnitsDsc->data = completeDescr(dataDscPtr, helpDscPtr, 0, errorDscPtr, validationDscPtr);
...
//printf("%x\n", descs_fid); 
		...
		return completeDescr((struct descriptor *)record_d, helpDscPtr, unitsDscPtr, errorDscPtr, validationDscPtr);
      case CLASS_APD:
		descs_fid = (*env)->GetFieldID(env, cls, "descs", "[LMDSplus/Data;");
        jdescs = (*env)->GetObjectField(env, obj, descs_fid);
  ...
  (JNIEnv *env, jclass cls, jint nid, jint ctx1, jint ctx2, jint nciNumCode, jint nciCode)
{
	...
	struct nci_itm nciList[] = 
		{{sizeof(int), 0, (char *)&nNids, &nNidsLen},
		{NciEND_OF_LIST, 0, 0, 0}};
  ...
  (JNIEnv *env, jclass cls, jint nid, jint ctx1, jint ctx2, jstring jname, jint usage)
{
	...
	if(status & 1) status = _TreeSetDefaultNid(ctx, nid);
	if(status & 1) status = _TreeAddNode(ctx, (char *)name, &newNid, (char)usage);
	if(status & 1) status = _TreeSetDefaultNid(ctx, defNid);
	(*env)->ReleaseStringUTFChars(env, jname, name);
	if(!(status & 1))
		throwMdsException(env, status);
	return newNid;
  ...
  (JNIEnv *env, jclass cls, jint nid, jint ctx1, jint ctx2, jstring jpath)
{
	...
	path = (*env)->GetStringUTFChars(env, jpath, 0);
	status = _TreeGetDefaultNid(ctx, &defNid);
	if(status & 1) status = _TreeFindNode(ctx, (char *)path, &delNid);
	if(status & 1) status = _TreeDeleteNodeInitialize(ctx, delNid, &count, 1);
	if(status & 1)_TreeDeleteNodeExecute(ctx);
	if(status & 1) status = _TreeSetDefaultNid(ctx, defNid);
	(*env)->ReleaseStringUTFChars(env, jpath, path);
	if(!(status & 1))
  ...
  (JNIEnv *env, jclass cls, jint nid, jint ctx1, jint ctx2, jstring jname, jstring jtype)
{
	...
	status = _TreeGetDefaultNid(ctx, &defNid);
	if(status & 1) status = _TreeSetDefaultNid(ctx, nid);
	if(status & 1) status = _TreeAddConglom(ctx, (char *)name, (char *)type, &newNid);
  ...
  (JNIEnv *env, jclass cls, jint nid, jint ctx1, jint ctx2, jint parentNid, jstring jpath)
{
	...
	path = (*env)->GetStringUTFChars(env, jpath, 0);
	status = _TreeGetDefaultNid(ctx, &defNid);
	if(status & 1) status = _TreeSetDefaultNid(ctx, parentNid);
	if(status & 1) status = _TreeRenameNode(ctx, nid, (char *)path);
	_TreeSetDefaultNid(ctx, defNid);
	(*env)->ReleaseStringUTFChars(env, jpath, path);
	if(!(status & 1))
		throwMdsException(env, status);
